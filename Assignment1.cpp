...
unsigned spliteNode(unsigned blockNumber, float score,unsigned currentD){
    ...
    unsigned leftNodeNum, rightNodeNum, parentNodeNum;
    ...
    btreeData tempNewNodeData, tempCurrentNodeData;
